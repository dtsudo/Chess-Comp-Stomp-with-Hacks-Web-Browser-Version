...
{
	public class Credits_Font_LicenseText
	{
		public static string GetLicenseText()
		{
			return @"dtchessfont.otf, dtchessfont.ttf, and dtchessfont.woff are licensed under the SIL Open Font License, Version 1.1.
...
OTHER DEALINGS IN THE FONT SOFTWARE.".Replace("\r", "").Replace("\t", "    ");
		}
	}
}
