...
namespace ChessCompStompWithHacksLibrary
{
	...
	public class HackDisplayDesktop
	{
		private Hack hack;
		private int x;
		private int y;
		...
		public void RenderHoverDisplay(IDisplayOutput<GameImage, GameFont> displayOutput)
		{
			if (this.isHover)
			{
				...
				int x;
				if (this.mouseX + width > GlobalConstants.DESKTOP_WINDOW_WIDTH)
					x = this.mouseX - width;
				else
					x = this.mouseX;
		...
		public void RenderButtonDisplay(IDisplayOutput<GameImage, GameFont> displayOutput)
		{
			...
			if (hasResearchedHack)
				backgroundColor = HackDisplay.GetResearchedHackBackgroundColor(theme: this.theme);
