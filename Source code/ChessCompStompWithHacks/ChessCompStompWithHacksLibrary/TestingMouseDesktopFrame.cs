...
namespace ChessCompStompWithHacksLibrary
{
	...
	public class TestingMouseDesktopFrame : IFrame<GameImage, GameFont, GameSound, GameMusic>
	{
		...
		public TestingMouseDesktopFrame(GlobalState globalState, SessionState sessionState)
		{
