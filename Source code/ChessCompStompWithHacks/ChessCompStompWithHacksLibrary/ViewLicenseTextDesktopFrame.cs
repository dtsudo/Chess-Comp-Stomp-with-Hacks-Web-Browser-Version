...
namespace ChessCompStompWithHacksLibrary
{
	...
	public class ViewLicenseTextDesktopFrame : IFrame<GameImage, GameFont, GameSound, GameMusic>
	{
		...
		public ViewLicenseTextDesktopFrame(
			...
			IFrame<GameImage, GameFont, GameSound, GameMusic> underlyingFrame)
		{
			...
			this.scrollableTextDisplay = new ScrollableTextDisplay(
				x: 23,
				y: 23 + 100,
				width: GlobalConstants.DESKTOP_WINDOW_WIDTH - 48,
				height: GlobalConstants.DESKTOP_WINDOW_HEIGHT - 46 - 100,
		...
		public void Render(IDisplayOutput<GameImage, GameFont> displayOutput)
		{
			...
			displayOutput.DrawRectangle(
				x: 20,
				y: 20,
				width: GlobalConstants.DESKTOP_WINDOW_WIDTH - 41,
				height: GlobalConstants.DESKTOP_WINDOW_HEIGHT - 41,
				color: DTColor.White(),
				fill: true);
			...
			displayOutput.DrawRectangle(
				x: 20,
				y: 20,
				width: GlobalConstants.DESKTOP_WINDOW_WIDTH - 40,
				height: GlobalConstants.DESKTOP_WINDOW_HEIGHT - 40,
				color: DTColor.Black(),
				fill: false);
