...
namespace ChessCompStompWithHacksLibrary
{
	...
	public class TestingFontDesktopFrame : IFrame<GameImage, GameFont, GameSound, GameMusic>
	{
		private GlobalState globalState;
		private SessionState sessionState;

		public TestingFontDesktopFrame(GlobalState globalState, SessionState sessionState)
		{
			...
			IMusicProcessing musicProcessing)
		{
			...
			if (keyboardInput.IsPressed(Key.Enter) && !previousKeyboardInput.IsPressed(Key.Enter))
				return new TestingFontDesktopFrame2(globalState: this.globalState, sessionState: this.sessionState);
